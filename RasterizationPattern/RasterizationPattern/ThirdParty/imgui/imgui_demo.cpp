...
void ImGui::ShowTestWindow(bool* p_opened)
{
    ...
    static float bg_alpha = 1.f; // <0: default
    ...
    if (!ImGui::Begin("ImGui Demo", p_opened, ImVec2(550,30), bg_alpha, window_flags))
    {
    ...
    //             if (ImGui::IsItem_Active() || ImGui::IsItemHovered())
    ...
    //         ImGui::SmallButton("<<"); if (ImGui::IsItem_Active()) scroll_x_delta = -ImGui::GetIO().DeltaTime * 1000.0f;
    ...
    //         if (ImGui::IsItem_Active() && ImGui::IsMouseDragging()) { offset.x += ImGui::GetIO().MouseDelta.x; offset.y += ImGui::GetIO().MouseDelta.y; }
    ...
    //         ImGui::InputText("1", buf, IM_ARRAYSIZE(buf));
    //         if (ImGui::IsItem_Active()) has_focus = 1;
	// 
    //         if (focus_2) ImGui::SetKeyboardFocusHere();
    //         ImGui::InputText("2", buf, IM_ARRAYSIZE(buf));
    //         if (ImGui::IsItem_Active()) has_focus = 2;
	// 
    //         ImGui::PushAllowKeyboardFocus(false);
    //         if (focus_3) ImGui::SetKeyboardFocusHere();
    //         ImGui::InputText("3 (tab skip)", buf, IM_ARRAYSIZE(buf));
    //         if (ImGui::IsItem_Active()) has_focus = 3;
    //         ImGui::PopAllowKeyboardFocus();
    //         if (has_focus)
    ...
    //     {
    //         ImGui::TextWrapped("You can use ImGui::GetItem_ActiveDragDelta() to query for the dragged amount on any widget.");
    //         ImGui::Button("Drag Me");
    //         if (ImGui::IsItem_Active())
    //         {
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* opened)
    {
        ...
        if (ImGui::IsItemHovered() || (ImGui::IsRootWindowOrAnyChildFocused() && !ImGui::IsAnyItem_Active() && !ImGui::IsMouseClicked(0)))
